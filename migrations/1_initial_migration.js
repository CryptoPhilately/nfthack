...
module.exports = function (deployer) {
  deployer.then(async () => {
    ...
    fs.writeFileSync('./src/config/CollectionsABI.json', JSON.stringify(collectionsAbi, null, ' '))
    fs.writeFileSync('./src/config/DepositoryABI.json', JSON.stringify(depositoryAbi, null, ' '))
    fs.writeFileSync('./src/config/StampsABI.json', JSON.stringify(stampsAbi, null, ' '))
